      ...
      <div className={styles.blockTable}>
        <table className={"customTable"}>
          ...
          <tr>
            <td>
              <div className={styles.dflex}>
                ...
                <Typography.Text>Block Height:</Typography.Text>
              </div>
            </td>
            <td>
              <div style={{display: "flex"}}>
                <b><Typography.Text>28018022 </Typography.Text></b>
          ...
          <tr>
            ...
            <td>
              <div style={{display: "flex", alignItems:"center", gap: 8}}>
                ...
                <Typography.Text className={"textSize"}>11 mins ago (May-08-2023 01:58:39 AM +UTC)</Typography.Text>
              </div>
            </td>
          </tr>
          <tr>
            <td>
              <div className={styles.dflex}>
                <Tooltip title={"The number of transactions in the block. Internal transaction is transactions as a result of contract execution that involves BNB value."}>
                  <Image width={22} src={iIcon} alt="time" />
                </Tooltip>
            ...
            <td>
              <Tooltip title={"Click to view Transactions"}><Button className={"textSize"}  type={"default"} size={"small"}>142 transaction</Button></Tooltip>
              <Typography.Text> and </Typography.Text>
              <Tooltip title={"Click to view Internal Transactions"}><Button className={"textSize"} type={"default"} size={"small"}>122 contract internal transactions</Button></Tooltip>
          ...
          <tr>
            ...
            <td>
              <Link href={"#"}>
                <Typography.Text className={"textGreen"}>0xb218c5d6af1f979ac42bc68d98a5a0d796c6ab01</Typography.Text>
              </Link> {""}
              <Typography.Text>
          ...
          <tr>
            ...
            <td>
              <Typography.Text>49,793 bytes</Typography.Text>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <Typography.Text>19,319,729 (13.96%)</Typography.Text>
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            ...
            <td>
              <Typography.Text>0x7a1187122a795a2f3f8af2430b1ecd4d1609f7106696bb5be410fd627e90c953</Typography.Text>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <Link href={"#"}> <Typography.Text className={"textGreen"}>0x0300e82da37926940836456ceec627206741ed346e82f81d16ebeb831de49c79</Typography.Text></Link>
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            ...
            <td>
              <Typography.Text>0x0000000000000000</Typography.Text>
            </td>
          </tr>
          </tbody>
        </table>
